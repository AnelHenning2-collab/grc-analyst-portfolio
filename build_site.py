...
SHARED_CSS = """
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .page-header .industry-tag {
      ...
      background: var(--navy); color: var(--white); margin-bottom: 14px;
    }
    .page-header h1 {
    ...
    .md-content h2 {
      ...
      padding-bottom: 6px;
      border-bottom: 2px solid rgba(30,39,97,0.12);
    }
    .md-content h3 { font-size: 1.05rem; font-weight: 700; color: var(--navy); margin: 20px 0 8px; }
    ...
    .md-content code {
      background: rgba(30,39,97,0.06); border-radius: 3px;
      padding: 2px 6px; font-size: 0.9rem; font-family: Consolas, monospace;
    }
    .md-content pre {
      background: rgba(30,39,97,0.06); border-radius: 6px;
    ...
    .md-content tr:nth-child(even) td { background: rgba(30,39,97,0.04); }
    .md-content tr:hover td { background: rgba(30,39,97,0.08); }
    ...
    .star-meta {
      font-size: 0.95rem; color: rgba(255,255,255,.75);
    ...
    .star-win .win-detail { font-size: 1rem; color: rgba(30,39,97,.75); }
...
<footer>
  ...
  <p style="margin-top:8px;color:rgba(255,255,255,.55);">
